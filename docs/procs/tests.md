...
- Verifies the lighting plane master, additive emitters, all ten states of the valid 256x256 CC0-derived gradient DMI, total tile-diameter conversion, configurable falloff, range-relative compact-core composition, independent beam/action glow cleanup, adapted legacy light intensity, dedicated player/admin test verbs, HUD plane isolation, and a representative transformation glow profile.
