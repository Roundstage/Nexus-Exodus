...
- Verifies the lighting plane master, additive emitters, adapted legacy light intensity, player/admin test verbs, HUD plane isolation, and a representative transformation glow profile.
