...
proc/Generate_dbz_character(n,for_avatar,new_only)
	...
	if(n == "Freeza")
		m.Form1Icon = 'C1.dmi'
		m.Form2Icon = 'ChangelingFriezaForm22.dmi'
		m.Form3Icon = 'ChangelingFriezaForm3.dmi'
		m.Form4Icon = 'ChangelingFrieza100.dmi'
	if(n == "Cooler")
		m.Form1Icon = 'C2.dmi'
		m.Form2Icon = 'C2.dmi'
		m.Form3Icon = 'C2.dmi'
		m.Form4Icon = 'C6.dmi'
	if(n == "King Cold")
		m.Form1Icon = 'ChangelingKoldForm2.dmi'
		m.Form2Icon = 'ChangelingKoldForm2.dmi'
		m.Form3Icon = 'ChangelingKoldForm2.dmi'
		m.Form4Icon = 'ChangelingKoldForm2.dmi'
	if(n == "Bulma")
		m.bp_mult *= 0.5
...
proc/DBCharIcon(n)
	switch(n)
		...
		if("Chaotsu") return 'SpiritDoll.dmi'
		if("Master Roshi") return 'BaseHumanPale.dmi'
		if("Raditz") return 'BaseHumanTan.dmi'
		if("Kami") return 'NamekOld.dmi'
		if("Mr Popo") return 'CustomMale.dmi'
		if("Nappa") return 'WhiteMaleMuscular3.dmi'
		if("Turles") return 'BaseHumanTan.dmi'
		if("Bardock") return 'BaseHumanTan.dmi'
		if("Garlic Jr") return 'Makyojin2.dmi'
		if("Greenster") return 'Saibaman.dmi'
		if("Guldo") return 'AlienGuldo.dmi'
		if("Burter") return 'AlienBurter.dmi'
		if("Jace") return 'CustomMale.dmi'+rgb(100,0,0)
		if("Recoome") return 'WhiteMaleMuscular3.dmi'
		if("Captain Ginyu") return 'RaceGinyu.dmi'
		if("Zarbon") return 'Alien4.dmi'
		if("Dodoria") return 'FatGuy.dmi'
		if("Appule") return 'Alien9.dmi'
		if("Kui") return 'RaceKui.dmi'
		if("Freeza") return 'C1.dmi'
		if("Cooler") return 'C2.dmi'
		if("King Cold") return 'ChangelingKoldForm2.dmi'
		if("Bulma") return 'NewPaleFemale.dmi'
		if("King Kai") return 'FatGuy.dmi'
		if("Chichi") return 'NewPaleFemale.dmi'
		if("19") return 'SpiritDoll.dmi'
