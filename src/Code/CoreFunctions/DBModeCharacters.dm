...
proc/Generate_dbz_character(n,for_avatar,new_only)
	...
	//temp handling block
	if(n == "Freeza")
		m.Form1Icon = 'src/Icons/PlayerIcons/BaseIcons/C1.dmi'
		m.Form2Icon = 'src/Icons/PlayerIcons/BaseIcons/ChangelingFriezaForm22.dmi'
		m.Form3Icon = 'src/Icons/PlayerIcons/BaseIcons/ChangelingFriezaForm3.dmi'
		m.Form4Icon = 'src/Icons/PlayerIcons/BaseIcons/ChangelingFrieza100.dmi'
	if(n == "Cooler")
		m.Form1Icon = 'src/Icons/PlayerIcons/BaseIcons/C2.dmi'
		m.Form2Icon = 'src/Icons/PlayerIcons/BaseIcons/C2.dmi'
		m.Form3Icon = 'src/Icons/PlayerIcons/BaseIcons/C2.dmi'
		m.Form4Icon = 'src/Icons/PlayerIcons/BaseIcons/C6.dmi'
	if(n == "King Cold")
		m.Form1Icon = 'src/Icons/PlayerIcons/BaseIcons/ChangelingKoldForm2.dmi'
		m.Form2Icon = 'src/Icons/PlayerIcons/BaseIcons/ChangelingKoldForm2.dmi'
		m.Form3Icon = 'src/Icons/PlayerIcons/BaseIcons/ChangelingKoldForm2.dmi'
		m.Form4Icon = 'src/Icons/PlayerIcons/BaseIcons/ChangelingKoldForm2.dmi'
	if(n == "Bulma")
		m.bp_mult *= 0.5
...
proc/DBCharIcon(n)
	switch(n)
		if("Goku") return 'src/Icons/PlayerIcons/BaseIcons/NewHumanIconsFromGuppinas/BaseHumanPale.dmi'
		if("Gohan") return 'src/Icons/PlayerIcons/BaseIcons/NewHumanIconsFromGuppinas/BaseHumanPale.dmi'
		if("Piccolo") return 'src/Icons/PlayerIcons/BaseIcons/Namek.dmi'
		if("Braal") return 'src/Icons/PlayerIcons/BaseIcons/NewHumanIconsFromGuppinas/BaseHumanTan.dmi'
		if("Trunks") return 'src/Icons/PlayerIcons/BaseIcons/NewHumanIconsFromGuppinas/BaseHumanPale.dmi'
		if("Yamcha") return 'src/Icons/PlayerIcons/BaseIcons/NewHumanIconsFromGuppinas/BaseHumanTan.dmi'
		if("Krillin") return 'src/Icons/PlayerIcons/BaseIcons/NewHumanIconsFromGuppinas/BaseHumanPale.dmi'
		if("Tien") return 'src/Icons/PlayerIcons/BaseIcons/NewHumanIconsFromGuppinas/BaseHumanPale.dmi'
		if("Chaotsu") return 'src/Icons/PlayerIcons/BaseIcons/SpiritDoll.dmi'
		if("Master Roshi") return 'src/Icons/PlayerIcons/BaseIcons/NewHumanIconsFromGuppinas/BaseHumanPale.dmi'
		if("Raditz") return 'src/Icons/PlayerIcons/BaseIcons/NewHumanIconsFromGuppinas/BaseHumanTan.dmi'
		if("Kami") return 'src/Icons/PlayerIcons/BaseIcons/NamekOld.dmi'
		if("Mr Popo") return 'src/Icons/PlayerIcons/BaseIcons/CustomMale.dmi'
		if("Nappa") return 'src/Icons/PlayerIcons/BaseIcons/ExGenesisHumans/WhiteMaleMuscular3.dmi'
		if("Turles") return 'src/Icons/PlayerIcons/BaseIcons/NewHumanIconsFromGuppinas/BaseHumanTan.dmi'
		if("Bardock") return 'src/Icons/PlayerIcons/BaseIcons/NewHumanIconsFromGuppinas/BaseHumanTan.dmi'
		if("Garlic Jr") return 'src/Icons/PlayerIcons/BaseIcons/Makyojin2.dmi'
		if("Greenster") return 'src/Icons/NPC/Saibaman.dmi'
		if("Guldo") return 'src/Icons/PlayerIcons/BaseIcons/AlienGuldo.dmi'
		if("Burter") return 'src/Icons/PlayerIcons/BaseIcons/AlienBurter.dmi'
		if("Jace") return 'src/Icons/PlayerIcons/BaseIcons/CustomMale.dmi'+rgb(100,0,0)
		if("Recoome") return 'src/Icons/PlayerIcons/BaseIcons/ExGenesisHumans/WhiteMaleMuscular3.dmi'
		if("Captain Ginyu") return 'src/Icons/PlayerIcons/BaseIcons/RaceGinyu.dmi'
		if("Zarbon") return 'src/Icons/PlayerIcons/BaseIcons/Alien4.dmi'
		if("Dodoria") return 'src/Icons/PlayerIcons/BaseIcons/FatGuy.dmi'
		if("Appule") return 'src/Icons/PlayerIcons/BaseIcons/Alien9.dmi'
		if("Kui") return 'src/Icons/PlayerIcons/BaseIcons/RaceKui.dmi'
		if("Freeza") return 'src/Icons/PlayerIcons/BaseIcons/C1.dmi'
		if("Cooler") return 'src/Icons/PlayerIcons/BaseIcons/C2.dmi'
		if("King Cold") return 'src/Icons/PlayerIcons/BaseIcons/ChangelingKoldForm2.dmi'
		if("Bulma") return 'src/Icons/PlayerIcons/BaseIcons/ExGenesisHumans/NewPaleFemale.dmi'
		if("King Kai") return 'src/Icons/PlayerIcons/BaseIcons/FatGuy.dmi'
		if("Chichi") return 'src/Icons/PlayerIcons/BaseIcons/ExGenesisHumans/NewPaleFemale.dmi'
		if("19") return 'src/Icons/PlayerIcons/BaseIcons/SpiritDoll.dmi'
...
proc/DBZ_character_race_by_name(n)
	switch(n)
		...
		if("Piccolo") return "Namekian"
		if("Braal") return "Saiyan"
		...
		if("Kami") return "Namekian"
		if("Nappa") return "Saiyan"
		if("Turles") return "Saiyan"
		if("Bardock") return "Saiyan"
