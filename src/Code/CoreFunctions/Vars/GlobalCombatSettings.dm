...
var
	...
	skill_big_bang_damage_factor = 28
	skill_charge_damage_factor = 8
	skill_cyber_charge_damage_factor = 6
	skill_makosen_damage_factor = 1.5
	skill_makosen_total_factor = 24
	skill_scatter_shot_damage_factor = 0.5
	skill_scatter_shot_total_factor = 30
	skill_attack_barrier_damage_factor = 0.75
	skill_attack_barrier_max_orbs = 20
	skill_shockwave_damage_factor = 1.5
	skill_shockwave_pulses = 7
	skill_explosion_damage_factor = 12
	skill_lunge_damage_factor = 8
	skill_dragon_rush_damage_factor = 8
	skill_rock_throw_powerful_damage_factor = 8
	skill_rock_throw_rapid_damage_factor = 2
	skill_rock_slide_damage_factor = 0.8
	skill_rock_slide_max_hits = 15
	skill_rock_tomb_damage_factor = 14
	skill_spin_blast_damage_factor = 2
	skill_spin_blast_projectiles = 4
	skill_genocide_damage_factor = 1.25
	skill_genocide_max_projectiles = 12
	skill_buster_barrage_damage_factor = 0.75
	skill_buster_barrage_total_factor = 24
	skill_buster_barrage_max_projectiles = 20
	skill_wall_of_flame_pulse_factor = 2
	skill_wall_of_flame_max_pulses = 6
	skill_dash_attack_min_factor = 5
	skill_dash_attack_max_factor = 18
	skill_dash_attack_step_factor = 0.55
	skill_dropkick_opening_factor = 11
	skill_dropkick_finisher_factor = 7
	skill_sokidan_damage_factor = 12
	skill_sokidan_total_factor = 24
	skill_kienzan_damage_factor = 18
	skill_kienzan_pierce_decay = 0.5
	skill_kikoho_damage_factor = 24
	skill_kikoho_self_damage_percent = 6
	skill_final_explosion_initial_factor = 10
	skill_final_explosion_max_factor = 40
	skill_self_destruct_damage_factor = 45
	skill_planet_destroy_event_factor = 3
	skill_planet_destroy_total_factor = 30
