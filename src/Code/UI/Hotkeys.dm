...
proc/Generate_hotbar_type_icons()
	...
	for(var/t in hotbar_types)
		...
		o.name=t
		switch(t)
			if("Empty") o.icon='src/Icons/UI/HotbarIcons/EmptyHotbarIcon.dmi'
			if("Melee") o.icon='src/Icons/UI/HotbarIcons/Melee.jpg'
			if("Blast") o.icon='src/Icons/UI/HotbarIcons/Blast.jpg'
			if("Beam") o.icon='src/Icons/UI/HotbarIcons/Beam.jpg'
			if("Buff") o.icon='src/Icons/UI/HotbarIcons/Buff.jpg'
			if("Defensive") o.icon='src/Icons/UI/HotbarIcons/Defensive.jpg'
			if("Support") o.icon='src/Icons/UI/HotbarIcons/Support.jpg'
			if("Other") o.icon='src/Icons/UI/HotbarIcons/Other.jpg'
			if("Ability") o.icon='src/Icons/UI/HotbarIcons/Ability.jpg'
			if("Transformation") o.icon='src/Icons/UI/HotbarIcons/Transformation.jpg'
			if("Combat item") o.icon='src/Icons/UI/HotbarIcons/CombatItem.jpg'
			if("Training method") o.icon='src/Icons/UI/HotbarIcons/Training.png'
			if("Item") o.icon='src/Icons/UI/HotbarIcons/Item.jpg'
		hotbar_type_icons+=o
...
proc/Get_hotbar_letter_icon(k)
	switch(k)
		if("Space") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/SpacebarHotbarIcon.jpg'
		if("0") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/Asset0HotbarIcon.jpg'
		if("1") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/Asset1HotbarIcon.jpg'
		if("2") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/Asset2HotbarIcon.jpg'
		if("3") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/Asset3HotbarIcon.jpg'
		if("4") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/Asset4HotbarIcon.jpg'
		if("5") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/Asset5HotbarIcon.jpg'
		if("6") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/Asset6HotbarIcon.jpg'
		if("7") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/Asset7HotbarIcon.jpg'
		if("8") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/Asset8HotbarIcon.jpg'
		if("9") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/Asset9HotbarIcon.jpg'
		if("A") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/AHotbarIcon.jpg'
		if("B") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/BHotbarIcon.jpg'
		if("C") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/CHotbarIcon.jpg'
		if("D") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/DHotbarIcon.jpg'
		if("E") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/EHotbarIcon.jpg'
		if("F") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/FHotbarIcon.jpg'
		if("G") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/GHotbarIcon.jpg'
		if("H") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/HHotbarIcon.jpg'
		if("I") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/IHotbarIcon.jpg'
		if("J") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/JHotbarIcon.jpg'
		if("K") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/KHotbarIcon.jpg'
		if("L") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/LHotbarIcon.jpg'
		if("M") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/MHotbarIcon.jpg'
		if("N") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/NHotbarIcon.jpg'
		if("O") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/OHotbarIcon.jpg'
		if("P") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/PHotbarIcon.jpg'
		if("Q") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/QHotbarIcon.jpg'
		if("R") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/RHotbarIcon.jpg'
		if("S") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/SHotbarIcon.jpg'
		if("T") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/THotbarIcon.jpg'
		if("U") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/UHotbarIcon.jpg'
		if("V") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/VHotbarIcon.jpg'
		if("W") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/WHotbarIcon.jpg'
		if("X") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/XHotbarIcon.jpg'
		if("Y") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/YHotbarIcon.jpg'
		if("Z") return 'src/Icons/UI/HotbarIcons/HotbarAlphabet/ZHotbarIcon.jpg'
