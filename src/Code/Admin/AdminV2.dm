			  ...
			  <tr height="1em" valign="top">
			    ...
			    <td width="80%" colspan="3">
			      <input class="form" type="text" name="name"
			       value="[html_encode("[getFormVar("info","name")]")]" size="30" maxlength="25" />
			      <span class="error">[errors["name"]]</span>
			    </td>
			  </tr>
			  <tr height="1em" valign="top">
			    <td width="20%"> <b>Age: (Decline: [html_encode("[getFormVar("info","decline")]")]) </b> </td>
			    <td width="30%">
			      <input class="form" type="text" name="age"
			       value="[html_encode("[getFormVar("info","age")]")]" size="5" maxlength="2" />
			  ...
			  <tr valign="top">
			    <td colspan="4">
			      ...
			      <textarea class="form" name="desc"
			       rows="5" cols="30">[html_encode("[getFormVar("info","desc")]")]</textarea>
...
upForm
	...
	admin_gains
		...
		FormSetTempVars(fname)
			...
			if(fname == "admin")
				...
				if(M && M.AdminLevel() >= 4 && !nexus_full_wipe_pending)
		...
		GenerateBody(list/errors=list())
			...
			<form name="info" action="byond://" method="get">
			  ...
			  <tr height="12px"><td colspan="4">
				...
				<tr height="1em" valign="top"><td width="30%"><b>adapt_mod: <td width="60%"><center>(Changes Adapt Mod)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="adapt_mod" value="[html_encode("[getFormVar("admin","adapt_mod")]")]" size="3" maxlength="20"/><span class="error">[errors["adapt_mod"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>alignment_on: <td width="60%"><center>(Toggles Alignment On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="alignment_on" value="[html_encode("[getFormVar("admin","alignment_on")]")]" size="3" maxlength="1"/><span class="error">[errors["alignment_on"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>allow_age_choosing: <td width="60%"><center>(Toggles Allow Age Choosing)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="allow_age_choosing" value="[html_encode("[getFormVar("admin","allow_age_choosing")]")]" size="3" maxlength="1"/><span class="error">[errors["allow_age_choosing"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Base_Stat_Gain: <td width="60%"><center>(Changes Base Stat Gain)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Base_Stat_Gain" value="[html_encode("[getFormVar("admin","Base_Stat_Gain")]")]" size="3" maxlength="20"/><span class="error">[errors["Base_Stat_Gain"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>BP_Cap: <td width="60%"><center>(Changes Bp Cap)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="BP_Cap" value="[html_encode("[getFormVar("admin","BP_Cap")]")]" size="3" maxlength="20"/><span class="error">[errors["BP_Cap"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>bp_soft_cap: <td width="60%"><center>(Changes Bp Soft Cap)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="bp_soft_cap" value="[html_encode("[getFormVar("admin","bp_soft_cap")]")]" size="3" maxlength="20"/><span class="error">[errors["bp_soft_cap"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>death_anger_gives_ssj: <td width="60%"><center>(Toggles Death Anger Gives Ssj)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="death_anger_gives_ssj" value="[html_encode("[getFormVar("admin","death_anger_gives_ssj")]")]" size="3" maxlength="1"/><span class="error">[errors["death_anger_gives_ssj"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>energy_cap: <td width="60%"><center>(Changes Energy Cap)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="energy_cap" value="[html_encode("[getFormVar("admin","energy_cap")]")]" size="3" maxlength="20"/><span class="error">[errors["energy_cap"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>feats_on: <td width="60%"><center>(Toggles Feats On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="feats_on" value="[html_encode("[getFormVar("admin","feats_on")]")]" size="3" maxlength="1"/><span class="error">[errors["feats_on"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Gain: <td width="60%"><center>(Changes Gain)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Gain" value="[html_encode("[getFormVar("admin","Gain")]")]" size="3" maxlength="20"/><span class="error">[errors["Gain"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>godKiMasteryMod: <td width="60%"><center>(Changes Godkimasterymod)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="godKiMasteryMod" value="[html_encode("[getFormVar("admin","godKiMasteryMod")]")]" size="3" maxlength="20"/><span class="error">[errors["godKiMasteryMod"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>gravity_mastery_mod: <td width="60%"><center>(Changes Gravity Mastery Mod)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="gravity_mastery_mod" value="[html_encode("[getFormVar("admin","gravity_mastery_mod")]")]" size="3" maxlength="20"/><span class="error">[errors["gravity_mastery_mod"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>incline_on: <td width="60%"><center>(Toggles Incline On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="incline_on" value="[html_encode("[getFormVar("admin","incline_on")]")]" size="3" maxlength="1"/><span class="error">[errors["incline_on"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>inspire_allowed: <td width="60%"><center>(Toggles Inspire Allowed)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="inspire_allowed" value="[html_encode("[getFormVar("admin","inspire_allowed")]")]" size="3" maxlength="1"/><span class="error">[errors["inspire_allowed"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Ki_Gain: <td width="60%"><center>(Changes Ki Gain)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Ki_Gain" value="[html_encode("[getFormVar("admin","Ki_Gain")]")]" size="3" maxlength="20"/><span class="error">[errors["Ki_Gain"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Learn_Disabled: <td width="60%"><center>(Toggles Learn Disabled)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Learn_Disabled" value="[html_encode("[getFormVar("admin","Learn_Disabled")]")]" size="3" maxlength="1"/><span class="error">[errors["Learn_Disabled"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>leech_strongest: <td width="60%"><center>(Changes Leech Strongest)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="leech_strongest" value="[html_encode("[getFormVar("admin","leech_strongest")]")]" size="3" maxlength="20"/><span class="error">[errors["leech_strongest"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>max_auto_leech: <td width="60%"><center>(Changes Max Auto Leech)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="max_auto_leech" value="[html_encode("[getFormVar("admin","max_auto_leech")]")]" size="3" maxlength="20"/><span class="error">[errors["max_auto_leech"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>npcs_give_hbtc_keys: <td width="60%"><center>(Toggles Npcs Give Hbtc Keys)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="npcs_give_hbtc_keys" value="[html_encode("[getFormVar("admin","npcs_give_hbtc_keys")]")]" size="3" maxlength="1"/><span class="error">[errors["npcs_give_hbtc_keys"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>offline_gains: <td width="60%"><center>(Changes Offline Gains)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="offline_gains" value="[html_encode("[getFormVar("admin","offline_gains")]")]" size="3" maxlength="20"/><span class="error">[errors["offline_gains"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>old_age_on: <td width="60%"><center>(Toggles Old Age On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="old_age_on" value="[html_encode("[getFormVar("admin","old_age_on")]")]" size="3" maxlength="1"/><span class="error">[errors["old_age_on"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>race_stats_only_mode: <td width="60%"><center>(Toggles Race Stats Only Mode)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="race_stats_only_mode" value="[html_encode("[getFormVar("admin","race_stats_only_mode")]")]" size="3" maxlength="1"/><span class="error">[errors["race_stats_only_mode"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Resource_Multiplier: <td width="60%"><center>(Changes Resource Multiplier)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Resource_Multiplier" value="[html_encode("[getFormVar("admin","Resource_Multiplier")]")]" size="3" maxlength="20"/><span class="error">[errors["Resource_Multiplier"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>server_zenkai: <td width="60%"><center>(Changes Server Zenkai)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="server_zenkai" value="[html_encode("[getFormVar("admin","server_zenkai")]")]" size="3" maxlength="20"/><span class="error">[errors["server_zenkai"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>SP_Multiplier: <td width="60%"><center>(Changes Sp Multiplier)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="SP_Multiplier" value="[html_encode("[getFormVar("admin","SP_Multiplier")]")]" size="3" maxlength="20"/><span class="error">[errors["SP_Multiplier"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>ssj_easy: <td width="60%"><center>(Toggles Ssj Easy)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="ssj_easy" value="[html_encode("[getFormVar("admin","ssj_easy")]")]" size="3" maxlength="1"/><span class="error">[errors["ssj_easy"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>SSj_Mastery: <td width="60%"><center>(Changes Ssj Mastery)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="SSj_Mastery" value="[html_encode("[getFormVar("admin","SSj_Mastery")]")]" size="3" maxlength="20"/><span class="error">[errors["SSj_Mastery"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Start_BP: <td width="60%"><center>(Changes Start Bp)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Start_BP" value="[html_encode("[getFormVar("admin","Start_BP")]")]" size="3" maxlength="20"/><span class="error">[errors["Start_BP"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Stat_Leech: <td width="60%"><center>(Changes Stat Leech)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Stat_Leech" value="[html_encode("[getFormVar("admin","Stat_Leech")]")]" size="3" maxlength="20"/><span class="error">[errors["Stat_Leech"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>strongest_bp_gain_penalty: <td width="60%"><center>(Changes Strongest Bp Gain Penalty)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="strongest_bp_gain_penalty" value="[html_encode("[getFormVar("admin","strongest_bp_gain_penalty")]")]" size="3" maxlength="20"/><span class="error">[errors["strongest_bp_gain_penalty"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Train_Disabled: <td width="60%"><center>(Toggles Train Disabled)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Train_Disabled" value="[html_encode("[getFormVar("admin","Train_Disabled")]")]" size="3" maxlength="1"/><span class="error">[errors["Train_Disabled"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>trainingHours: <td width="60%"><center>(Changes Traininghours)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="trainingHours" value="[html_encode("[getFormVar("admin","trainingHours")]")]" size="3" maxlength="20"/><span class="error">[errors["trainingHours"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>trainingRestoreHours: <td width="60%"><center>(Changes Trainingrestorehours)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="trainingRestoreHours" value="[html_encode("[getFormVar("admin","trainingRestoreHours")]")]" size="3" maxlength="20"/><span class="error">[errors["trainingRestoreHours"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Year: <td width="60%"><center>(Changes Year)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Year" value="[html_encode("[getFormVar("admin","Year")]")]" size="3" maxlength="20"/><span class="error">[errors["Year"]]</span></td></tr>
	...
	admin_world
		...
		FormInitTempVars()
			...
			initFormVar("admin", "SENSE_SYSTEM_SHOW_STAT_BUILD", SENSE_SYSTEM_SHOW_STAT_BUILD)
		...
		GenerateBody(list/errors=list())
			...
			<form name="info" action="byond://" method="get">
			  ...
			  <tr height="12px"><td colspan="4">
				...
				<tr height="1em" valign="top"><td width="30%"><b>RP Server Packs: <td width="60%"><center>(0=Off for RP,1=On for RP)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="hostAllowsPacksOnRP" value="[html_encode("[getFormVar("admin","hostAllowsPacksOnRP")]")]" size="3" maxlength="1"/><span class="error">[errors["hostAllowsPacksOnRP"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Pack KT Toggle: <td width="60%"><center>(0=No KT, 1=Pack KT)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="pack_KT_allowed" value="[html_encode("[getFormVar("admin","pack_KT_allowed")]")]" size="3" maxlength="1"/><span class="error">[errors["pack_KT_allowed"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Hell Altar: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="hellAltar" value="[html_encode("[getFormVar("admin","hellAltar")]")]" size="3" maxlength="1"/><span class="error">[errors["hellAltar"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Braal Gym: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="BraalGym" value="[html_encode("[getFormVar("admin","BraalGym")]")]" size="3" maxlength="1"/><span class="error">[errors["BraalGym"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Bounties on Good People: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="allow_good_bounties" value="[html_encode("[getFormVar("admin","allow_good_bounties")]")]" size="3" maxlength="1"/><span class="error">[errors["allow_good_bounties"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Countdown Toggle: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="give_countdown_verb" value="[html_encode("[getFormVar("admin","give_countdown_verb")]")]" size="3" maxlength="1"/><span class="error">[errors["give_countdown_verb"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Whisper Toggle: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="give_whisper_verb" value="[html_encode("[getFormVar("admin","give_whisper_verb")]")]" size="3" maxlength="1"/><span class="error">[errors["give_whisper_verb"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Unlock HBTC: <td width="60%"><center>(0=Locked, 1=Unlocked)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="anyone_can_enter_hbtc" value="[html_encode("[getFormVar("admin","anyone_can_enter_hbtc")]")]" size="3" maxlength="1"/><span class="error">[errors["anyone_can_enter_hbtc"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Admin Free Building: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="admins_build_free" value="[html_encode("[getFormVar("admin","admins_build_free")]")]" size="3" maxlength="1"/><span class="error">[errors["admins_build_free"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Character Names in OOC: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="show_names_in_ooc" value="[html_encode("[getFormVar("admin","show_names_in_ooc")]")]" size="3" maxlength="1"/><span class="error">[errors["show_names_in_ooc"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Voting Toggle: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="voting_allowed" value="[html_encode("[getFormVar("admin","voting_allowed")]")]" size="3" maxlength="1"/><span class="error">[errors["voting_allowed"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Lizard Sphere Announcements: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="announce_dragon_balls" value="[html_encode("[getFormVar("admin","announce_dragon_balls")]")]" size="3" maxlength="1"/><span class="error">[errors["announce_dragon_balls"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Offline Resource Deprecation: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="lose_resources_on_logout" value="[html_encode("[getFormVar("admin","lose_resources_on_logout")]")]" size="3" maxlength="1"/><span class="error">[errors["lose_resources_on_logout"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Lethal Doors: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="doors_kill" value="[html_encode("[getFormVar("admin","doors_kill")]")]" size="3" maxlength="1"/><span class="error">[errors["doors_kill"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Drop Items on Death: <td width="60%"><center>(0=No, 1=Yes)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="drop_items_on_death" value="[html_encode("[getFormVar("admin","drop_items_on_death")]")]" size="3" maxlength="1"/><span class="error">[errors["drop_items_on_death"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Guest Key Toggle: <td width="60%"><center>(0=Banned, 1=Allowed)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="allow_guests" value="[html_encode("[getFormVar("admin","allow_guests")]")]" size="3" maxlength="1"/><span class="error">[errors["allow_guests"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Im Trapped Toggle: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="im_trapped_allowed" value="[html_encode("[getFormVar("admin","im_trapped_allowed")]")]" size="3" maxlength="1"/><span class="error">[errors["im_trapped_allowed"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Safezones: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Safezones" value="[html_encode("[getFormVar("admin","Safezones")]")]" size="3" maxlength="1"/><span class="error">[errors["Safezones"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Era Voting: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="can_era_vote" value="[html_encode("[getFormVar("admin","can_era_vote")]")]" size="3" maxlength="1"/><span class="error">[errors["can_era_vote"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Player Wipe Voting: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Can_Pwipe_Vote" value="[html_encode("[getFormVar("admin","Can_Pwipe_Vote")]")]" size="3" maxlength="1"/><span class="error">[errors["Can_Pwipe_Vote"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Ban Voting: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Allow_Ban_Votes" value="[html_encode("[getFormVar("admin","Allow_Ban_Votes")]")]" size="3" maxlength="1"/><span class="error">[errors["Allow_Ban_Votes"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Wasted Transition: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="gta5_wasted" value="[html_encode("[getFormVar("admin","gta5_wasted")]")]" size="3" maxlength="1"/><span class="error">[errors["gta5_wasted"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Saga Toggle: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="sagas" value="[html_encode("[getFormVar("admin","sagas")]")]" size="3" maxlength="1"/><span class="error">[errors["sagas"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Alts: <td width="60%"><center>(Allow or Disallow Alts)</center></td></b></td><td width="10%" colspan="3"><select class="form" name="alts" value="[html_encode("[getFormVar("admin","alts")]")]" size="3" /><option value="allowed" selected>Allowed</option><option value="disallowed">Disallowed</option><option value="allowed only if seperate computers">Seperate PCs</option></select><span class="error">[errors["alts"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>RP President: <td width="60%"><center>(Key of RP President)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="RP_President" value="[html_encode("[getFormVar("admin","RP_President")]")]" size="3" maxlength="30"/><span class="error">[errors["RP_President"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Tournament Prize: <td width="60%"><center>(Tournament Prize Amount)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Tournament_Prize" value="[html_encode("[getFormVar("admin","Tournament_Prize")]")]" size="3" maxlength="20"/><span class="error">[errors["Tournament_Prize"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Safezone_Distance: <td width="60%"><center>(Safezone Radius)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Safezone_Distance" value="[html_encode("[getFormVar("admin","Safezone_Distance")]")]" size="3" maxlength="20"/><span class="error">[errors["Safezone_Distance"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Max_Players: <td width="60%"><center>(Player Limit)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Max_Players" value="[html_encode("[getFormVar("admin","Max_Players")]")]" size="3" maxlength="20"/><span class="error">[errors["Max_Players"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Skill Tournament Chance: <td width="60%"><center>(Percent Chance of Skill Tournament)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="skill_tournament_chance" value="[html_encode("[getFormVar("admin","skill_tournament_chance")]")]" size="3" maxlength="20"/><span class="error">[errors["skill_tournament_chance"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Meteor Density: <td width="60%"><center>(Multiplier for Meteor Spawning)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="meteor_density" value="[html_encode("[getFormVar("admin","meteor_density")]")]" size="3" maxlength="20"/><span class="error">[errors["meteor_density"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Alt Limit: <td width="60%"><center>(Max Number of Alts per Person)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="alt_limit" value="[html_encode("[getFormVar("admin","alt_limit")]")]" size="3" maxlength="20"/><span class="error">[errors["alt_limit"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>P-Wipe Vote Year: <td width="60%"><center>(Minimum Year for P-Wipe Vote)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="pwipe_vote_year" value="[html_encode("[getFormVar("admin","pwipe_vote_year")]")]" size="3" maxlength="20"/><span class="error">[errors["pwipe_vote_year"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>P-Wipe Vote BP <td width="60%"><center>(Minimum BP for P-Wipe Vote)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="pwipe_vote_bp" value="[html_encode("[getFormVar("admin","pwipe_vote_bp")]")]" size="3" maxlength="20"/><span class="error">[errors["pwipe_vote_bp"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Skill Tournament BP Bonus: <td width="60%"><center>(Changes Skill Tournament Bp Boost)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="skill_tournament_bp_boost" value="[html_encode("[getFormVar("admin","skill_tournament_bp_boost")]")]" size="3" maxlength="20"/><span class="error">[errors["skill_tournament_bp_boost"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Auto Reboot Time: <td width="60%"><center>(Hours between Auto Reboots)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="auto_reboot_hours" value="[html_encode("[getFormVar("admin","auto_reboot_hours")]")]" size="3" maxlength="20"/><span class="error">[errors["auto_reboot_hours"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Auto Reset BP: <td width="60%"><center>(Triggers Era Reset at set BP)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="auto_reset_bp_at" value="[html_encode("[getFormVar("admin","auto_reset_bp_at")]")]" size="3" maxlength="20"/><span class="error">[errors["auto_reset_bp_at"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>NPC Spawn Density: <td width="60%"><center>(Multiplier for NPC Spawn Density)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="npcDensity" value="[html_encode("[getFormVar("admin","npcDensity")]")]" size="3" maxlength="20"/><span class="error">[errors["npcDensity"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Default View Radius: <td width="60%"><center>(Default View Radius)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="defaultScreenSize" value="[html_encode("[getFormVar("admin","defaultScreenSize")]")]" size="3" maxlength="20"/><span class="error">[errors["defaultScreenSize"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Max View Radius: <td width="60%"><center>(Changes Max Screen Size)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="max_screen_size" value="[html_encode("[getFormVar("admin","max_screen_size")]")]" size="3" maxlength="20"/><span class="error">[errors["max_screen_size"]]</span></td></tr>

				<tr height="1em" valign="top"><td width="30%"><b>Can things (turfs, walls and objects) be broken?: <td width="60%"><center>(0 = False, 1 = True)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="CAN_BREAK_TURFS" value="[html_encode("[getFormVar("admin","CAN_BREAK_TURFS")]")]" size="3" maxlength="20"/><span class="error">[errors["CAN_BREAK_TURFS"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Show Character names on Who?: <td width="60%"><center>(0 = False, 1 = True)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="SHOW_CHAR_NAME_ON_WHO" value="[html_encode("[getFormVar("admin","SHOW_CHAR_NAME_ON_WHO")]")]" size="3" maxlength="20"/><span class="error">[errors["SHOW_CHAR_NAME_ON_WHO"]]</span></td></tr>

				<tr height="1em" valign="top"><td width="30%"><b>Show stat builds on Sense 3/Scan?: <td width="60%"><center>(0 = False, 1 = True)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="SENSE_SYSTEM_SHOW_STAT_BUILD" value="[html_encode("[getFormVar("admin","SENSE_SYSTEM_SHOW_STAT_BUILD")]")]" size="3" maxlength="20"/><span class="error">[errors["SENSE_SYSTEM_SHOW_STAT_BUILD"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Show vague info on Sense 3? (no numbers): <td width="60%"><center>(0 = False, 1 = True)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="SENSE_SYSTEM_SHOW_VAGUE_INFO" value="[html_encode("[getFormVar("admin","SENSE_SYSTEM_SHOW_VAGUE_INFO")]")]" size="3" maxlength="20"/><span class="error">[errors["SENSE_SYSTEM_SHOW_VAGUE_INFO"]]</span></td></tr>

				<tr height="1em" valign="top"><td width="30%"><b>Which KO marks unconsciousness? (0 = KO 1, 1 = KO 2, 2 = KO 3, 3 = KO 4, 4 = KO 5): <td width="60%"><center></center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="KO_SYSTEM_UNCONSCIOUS_KO" value="[html_encode("[getFormVar("admin","KO_SYSTEM_UNCONSCIOUS_KO")]")]" size="3" maxlength="20"/><span class="error">[errors["KO_SYSTEM_UNCONSCIOUS_KO"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>How long should someone be unconscious for? (10 = 1 second, 6000 = 600 seconds (10 minutes)): <td width="60%"><center></center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="KO_SYSTEM_UNCONSCIOUS_KO_DURATION" value="[html_encode("[getFormVar("admin","KO_SYSTEM_UNCONSCIOUS_KO_DURATION")]")]" size="3" maxlength="20"/><span class="error">[errors["KO_SYSTEM_UNCONSCIOUS_KO_DURATION"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>How long should someone be out for after a normal KO? (10 = 1 second, 1800 = 180 seconds (3 minutes)): <td width="60%"><center></center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="KO_SYSTEM_NORMAL_KO_DURATION" value="[html_encode("[getFormVar("admin","KO_SYSTEM_NORMAL_KO_DURATION")]")]" size="3" maxlength="20"/><span class="error">[errors["KO_SYSTEM_NORMAL_KO_DURATION"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>After how long will someone be considered out of combat? (10 = 1 second, 6000 = 600 seconds (10 minutes)): <td width="60%"><center></center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="KO_SYSTEM_OUT_OF_COMBAT_TIMER" value="[html_encode("[getFormVar("admin","KO_SYSTEM_OUT_OF_COMBAT_TIMER")]")]" size="3" maxlength="20"/><span class="error">[errors["KO_SYSTEM_OUT_OF_COMBAT_TIMER"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>In which internal will the message that someone is healing be shown? (10 = 1 second, 300 = 30 seconds): <td width="60%"><center></center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="KO_SYSTEM_HEAL_ANNOUNCE_TIMER" value="[html_encode("[getFormVar("admin","KO_SYSTEM_HEAL_ANNOUNCE_TIMER")]")]" size="3" maxlength="20"/><span class="error">[errors["KO_SYSTEM_HEAL_ANNOUNCE_TIMER"]]</span></td></tr>

				<tr height="1em" valign="top"><td width="30%"><b>How much lifespan should be lost when someone is cloned? (0.95 = 5%, 0.4 = 60% (100 - lifespan)%): <td width="60%"><center></center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="CLONING_SYSTEM_LIFESPAN_LOSS" value="[html_encode("[getFormVar("admin","CLONING_SYSTEM_LIFESPAN_LOSS")]")]" size="3" maxlength="20"/><span class="error">[errors["CLONING_SYSTEM_LIFESPAN_LOSS"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>How much potential should be lost when someone is cloned? (0.72 = 28%, 0.4 = 60% (100 - potential)%): <td width="60%"><center></center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="CLONING_SYSTEM_POTENTIAL_LOSS" value="[html_encode("[getFormVar("admin","CLONING_SYSTEM_POTENTIAL_LOSS")]")]" size="3" maxlength="20"/><span class="error">[errors["CLONING_SYSTEM_POTENTIAL_LOSS"]]</span></td></tr>

				<tr height="1em" valign="top"><td width="30%"><b>How long should the window of repeated usage for T-Heal be? (10 = 1 second, 6000 = 600 seconds (10 minutes)): <td width="60%"><center></center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="KO_SYSTEM_T_HEAL_FAIL_COOLDOWN" value="[html_encode("[getFormVar("admin","KO_SYSTEM_T_HEAL_FAIL_COOLDOWN")]")]" size="3" maxlength="20"/><span class="error">[errors["KO_SYSTEM_T_HEAL_FAIL_COOLDOWN"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>How many times can someone use the T-Heal inside the repeated usage period before having side effects? (0 = never, 2 = 2 times): <td width="60%"><center></center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="KO_SYSTEM_T_HEAL_USAGE_LIMIT" value="[html_encode("[getFormVar("admin","KO_SYSTEM_T_HEAL_USAGE_LIMIT")]")]" size="3" maxlength="20"/><span class="error">[errors["KO_SYSTEM_T_HEAL_USAGE_LIMIT"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>How long should the cooldown be between Sensu Bean usages? (10 = 1 second, 6000 = 600 seconds (10 minutes)): <td width="60%"><center></center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="KO_SYSTEM_SENSU_COOLDOWN" value="[html_encode("[getFormVar("admin","KO_SYSTEM_SENSU_COOLDOWN")]")]" size="3" maxlength="20"/><span class="error">[errors["KO_SYSTEM_SENSU_COOLDOWN"]]</span></td></tr>
			<tr height="1em">
			  	<td colspan="4" align="right"> <input type="submit" value="Submit" />
			  	<input type="reset" value="Reset" /> </td>
			  </tr>
		...
		GenerateBody(list/errors=list())
			...
			<form name="info" action="byond://" method="get">
			  ...
			  <tr height="12px"><td colspan="4">
				...
				<tr height="1em" valign="top"><td width="30%"><b>Battlgrounds: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="battlegroundSystem" value="[html_encode("[getFormVar("admin","battlegroundSystem")]")]" size="3" maxlength="1"/><span class="error">[errors["battlegroundSystem"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Battlegrounds Spawn: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="battleground_spawn_choice_on" value="[html_encode("[getFormVar("admin","battleground_spawn_choice_on")]")]" size="3" maxlength="1"/><span class="error">[errors["battleground_spawn_choice_on"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Battleground Master Boost: <td width="60%"><center>(BP Multiplier for Battleground Master)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="battleground_master_bp_mult" value="[html_encode("[getFormVar("admin","battleground_master_bp_mult")]")]" size="3" maxlength="20"/><span class="error">[errors["battleground_master_bp_mult"]]</span></td></tr>
		...
		GenerateBody(list/errors=list())
			...
			<form name="info" action="byond://" method="get">
			  ...
			  <tr height="12px"><td colspan="4">
				...
				<tr height="1em" valign="top"><td width="30%"><b>Make Legendary Saiyan Common: <td width="60%"><center>(0=Rare, 1=Common)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="lssj_common_race" value="[html_encode("[getFormVar("admin","lssj_common_race")]")]" size="3" maxlength="1"/><span class="error">[errors["lssj_common_race"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Make Icer Common: <td width="60%"><center>(0=Rare, 1=Common)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="icer_common_race" value="[html_encode("[getFormVar("admin","icer_common_race")]")]" size="3" maxlength="1"/><span class="error">[errors["icer_common_race"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Make All Rare Races Common: <td width="60%"><center>(0=Rare, 1=Common; includes Legendary Saiyan, Frost Lord, Cooler, and Grand Regent)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="all_rare_races_common" value="[html_encode("[getFormVar("admin","all_rare_races_common")]")]" size="3" maxlength="1"/><span class="error">[errors["all_rare_races_common"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Enable Majin Auto-Learning: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="majin_auto_learn" value="[html_encode("[getFormVar("admin","majin_auto_learn")]")]" size="3" maxlength="1"/><span class="error">[errors["majin_auto_learn"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Enable Imitate: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="imitate_allowed" value="[html_encode("[getFormVar("admin","imitate_allowed")]")]" size="3" maxlength="1"/><span class="error">[errors["imitate_allowed"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Max Saiyan Percentage: <td width="60%"><center>(Limit on Saiyan Population)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="max_Saiyan_percent" value="[html_encode("[getFormVar("admin","max_Saiyan_percent")]")]" size="3" maxlength="20"/><span class="error">[errors["max_Saiyan_percent"]]</span></td></tr>

				<tr height="1em" valign="top"><td width="30%"><b>Do Vampires Need to Feed? <td width="60%"><center>(0 = False, 1 = True)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="DO_VAMPIRES_NEED_TO_FEED" value="[html_encode("[getFormVar("admin","DO_VAMPIRES_NEED_TO_FEED")]")]" size="3" maxlength="1"/><span class="error">[errors["DO_VAMPIRES_NEED_TO_FEED"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Do Vampire Bites infect other players? <td width="60%"><center>(0=False, 1=True)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="DO_VAMPIRES_INFECT_ON_BITE" value="[html_encode("[getFormVar("admin","DO_VAMPIRES_INFECT_ON_BITE")]")]" size="3" maxlength="1"/><span class="error">[errors["DO_VAMPIRES_INFECT_ON_BITE"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Interval for Vampire Power to fall (vampire bpmod) <td width="60%"><center>(150 = 15 seconds, 600 = 60 seconds. 150 = 1 hour until lose all Vampire Power (so 1500 would be 10 hours). Minimum is 150)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="VAMPIRE_POWER_FALL_INTERVAL" value="[html_encode("[getFormVar("admin","VAMPIRE_POWER_FALL_INTERVAL")]")]" size="3" maxlength="10"/><span class="error">[errors["VAMPIRE_POWER_FALL_INTERVAL"]]</span></td></tr>

				<tr height="1em" valign="top"><td width="30%"><b>Do Players Start with Racial Skills? <td width="60%"><center>(0 = False, 1 = True)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="START_WITH_RACIAL_SKILLS" value="[html_encode("[getFormVar("admin","START_WITH_RACIAL_SKILLS")]")]" size="3" maxlength="1"/><span class="error">[errors["START_WITH_RACIAL_SKILLS"]]</span></td></tr>
		  <tr height="1em">
			  	<td colspan="4" align="right"> <input type="submit" value="Submit" />
			  	<input type="reset" value="Reset" /> </td>
			  </tr>
		...
		GenerateBody(list/errors=list())
			...
			<form name="info" action="byond://" method="get">
			  ...
			  <tr height="12px"><td colspan="4">
				...
				<tr height="1em" valign="top"><td width="30%"><br><b>Hide Energy Toggle: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="hide_energy_enabled" value="[html_encode("[getFormVar("admin","hide_energy_enabled")]")]" size="3" maxlength="1"/><span class="error">[errors["hide_energy_enabled"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>God Ki Toggle: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="allow_god_ki" value="[html_encode("[getFormVar("admin","allow_god_ki")]")]" size="3" maxlength="1"/><span class="error">[errors["allow_god_ki"]]</span></td></tr>

				<tr><td><br><center><b>Toggles</b></center></td></tr>

				<tr height="1em" valign="top"><td width="30%"><br><b>Disable Shockwaves: <td width="60%"><center>(0=On, 1=Off)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="shockwaves_off" value="[html_encode("[getFormVar("admin","shockwaves_off")]")]" size="3" maxlength="1"/><span class="error">[errors["shockwaves_off"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Disable Explosions: <td width="60%"><center>(0=On, 1=Off)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="explosions_off" value="[html_encode("[getFormVar("admin","explosions_off")]")]" size="3" maxlength="1"/><span class="error">[errors["explosions_off"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Disable Dust: <td width="60%"><center>(0=On, 1=Off)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="dust_off" value="[html_encode("[getFormVar("admin","dust_off")]")]" size="3" maxlength="1"/><span class="error">[errors["dust_off"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Disable Stat Lowering: <td width="60%"><center>(0=On, 1=Off)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="lower_stats_off" value="[html_encode("[getFormVar("admin","lower_stats_off")]")]" size="3" maxlength="1"/><span class="error">[errors["lower_stats_off"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Disable Ki: <td width="60%"><center>(0=On, 1=Off)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Ki_Disabled" value="[html_encode("[getFormVar("admin","Ki_Disabled")]")]" size="3" maxlength="1"/><span class="error">[errors["Ki_Disabled"]]</span></td></tr>

				<tr><td><br><center><b>Mechanics</b></center></td></tr>

				<tr height="1em" valign="top"><td width="30%"><br><b>Allow Ultra Instinct: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="allow_ultra_instinct" value="[html_encode("[getFormVar("admin","allow_ultra_instinct")]")]" size="3" maxlength="1"/><span class="error">[errors["allow_ultra_instinct"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Allow Dragon Rush: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="allow_dragon_rush" value="[html_encode("[getFormVar("admin","allow_dragon_rush")]")]" size="3" maxlength="1"/><span class="error">[errors["allow_dragon_rush"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Allow Custom Buffs: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="custom_buffs_allowed" value="[html_encode("[getFormVar("admin","custom_buffs_allowed")]")]" size="3" maxlength="1"/><span class="error">[errors["custom_buffs_allowed"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Global Beam Deflect Mod: <td width="60%"><center>(How easy beams are deflected. Default: 0.6)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="global_beam_deflect_mod" value="[html_encode("[getFormVar("admin","global_beam_deflect_mod")]")]" size="3" maxlength="10"/><span class="error">[errors["global_beam_deflect_mod"]]</span></td></tr>
				<tr><td><br><center><b>Settings</b></center></td></tr>

				<tr height="1em" valign="top"><td width="30%"><br><b>Force Cyber BP on KOd: <td width="60%"><center>(0=Disallowed, 1=Allowed)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="can_cyber_KOd_people" value="[html_encode("[getFormVar("admin","can_cyber_KOd_people")]")]" size="3" maxlength="1"/><span class="error">[errors["can_cyber_KOd_people"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Forced Injections: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="forced_injections" value="[html_encode("[getFormVar("admin","forced_injections")]")]" size="3" maxlength="1"/><span class="error">[errors["forced_injections"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Enable Ignore SI: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="can_ignore_SI" value="[html_encode("[getFormVar("admin","can_ignore_SI")]")]" size="3" maxlength="1"/><span class="error">[errors["can_ignore_SI"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Perma-Death: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Perma_Death" value="[html_encode("[getFormVar("admin","Perma_Death")]")]" size="3" maxlength="1"/><span class="error">[errors["Perma_Death"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Death Setting:<td width="60%"><center>(Changes Death Mode)</center></td></b></td><td width="10%" colspan="3"><select class="form" name="death_setting" value="[html_encode("[getFormVar("admin","death_setting")]")]" size="3" /><option value="default">Default</option><option value="Rebirth upon death">Auto Reincarnate</option></select><span class="error">[errors["death_setting"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>BP Exponent:<td width="60%"><center>(How bpwalls scale)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="bp_exponent" value="[html_encode("[getFormVar("admin","bp_exponent")]")]" size="3" maxlength="10"/><span class="error">[errors["bp_exponent"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Accuracy Exponent:<td width="60%"><center>(0.5 = scales 50% as much as BP, 0.2 = scales 20% as much as BP)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="GLOBAL_ACCURACY_EXPONENT" value="[html_encode("[getFormVar("admin","GLOBAL_ACCURACY_EXPONENT")]")]" size="3" maxlength="10"/><span class="error">[errors["GLOBAL_ACCURACY_EXPONENT"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>One Shot Start:<td width="60%"><center>(4 = 4x more BP)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="one_shot_start" value="[html_encode("[getFormVar("admin","one_shot_start")]")]" size="3" maxlength="10"/><span class="error">[errors["one_shot_start"]]</span></td></tr>
				<tr><td><br><center><b>Stats</b></center></td></tr>

				<tr height="1em" valign="top"><td width="30%"><br><b>Server Regeneration: <td width="60%"><center>(Changes Server Regeneration)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Server_Regeneration" value="[html_encode("[getFormVar("admin","Server_Regeneration")]")]" size="3" maxlength="20"/><span class="error">[errors["Server_Regeneration"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Server Recovery: <td width="60%"><center>(Changes Server Recovery)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Server_Recovery" value="[html_encode("[getFormVar("admin","Server_Recovery")]")]" size="3" maxlength="20"/><span class="error">[errors["Server_Recovery"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>KO Time Multiplier: <td width="60%"><center>(1x Timer = 80 Seconds w/ 1x Regen)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="KO_Time" value="[html_encode("[getFormVar("admin","KO_Time")]")]" size="3" maxlength="20"/><span class="error">[errors["KO_Time"]]</span></td></tr>

				<tr height="1em" valign="top"><td width="30%"><b>Melee Power: <td width="60%"><center>(Melee Damage Multiplier)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="melee_power" value="[html_encode("[getFormVar("admin","melee_power")]")]" size="3" maxlength="20"/><span class="error">[errors["melee_power"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Melee speed delay severity <td width="60%"><center>(Default: 0.52)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="melee_delay_severity" value="[html_encode("[getFormVar("admin","melee_delay_severity")]")]" size="3" maxlength="20"/><span class="error">[errors["melee_delay_severity"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Melee speed offset <td width="60%"><center>(100 = 100% based on average speed, 50 = 50% based on average speed)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="GLOBAL_MELEE_SPEED_OFFSET" value="[html_encode("[getFormVar("admin","GLOBAL_MELEE_SPEED_OFFSET")]")]" size="3" maxlength="20"/><span class="error">[errors["GLOBAL_MELEE_SPEED_OFFSET"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Ki Power: <td width="60%"><center>(Ki Damage Multiplier)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="ki_power" value="[html_encode("[getFormVar("admin","ki_power")]")]" size="3" maxlength="20"/><span class="error">[errors["ki_power"]]</span></td></tr>

				<tr height="1em" valign="top"><td width="30%"><b>Stun Time Multiplier: <td width="60%"><center>(Multiplies Stun Duration)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="global_stun_mod" value="[html_encode("[getFormVar("admin","global_stun_mod")]")]" size="3" maxlength="20"/><span class="error">[errors["global_stun_mod"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Knockback Multiplier: <td width="60%"><center>(Changes Knockback Mod)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="knockback_mod" value="[html_encode("[getFormVar("admin","knockback_mod")]")]" size="3" maxlength="20"/><span class="error">[errors["knockback_mod"]]</span></td></tr>

				<tr height="1em" valign="top"><td width="30%"><b>God-Fist Damage Multiplier: <td width="60%"><center>(Changes God-Fist Damage)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="God_FistMod" value="[html_encode("[getFormVar("admin","God_FistMod")]")]" size="3" maxlength="20"/><span class="error">[errors["God_FistMod"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Max Custom Buff BP Multi: <td width="60%"><center>(Limit of max multiplier for BP setting in Buffs)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="max_buff_bp" value="[html_encode("[getFormVar("admin","max_buff_bp")]")]" size="3" maxlength="20"/><span class="error">[errors["max_buff_bp"]]</span></td></tr>

				<tr><td><br><center><b>Afterlife</b></center></td></tr>

				<tr height="1em" valign="top"><td width="30%"><br><b>Demon Boost in Hell: <td width="60%"><center>(BP Multiplier for Demons in Hell)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="demon_hell_boost" value="[html_encode("[getFormVar("admin","demon_hell_boost")]")]" size="3" maxlength="20"/><span class="error">[errors["demon_hell_boost"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Kai Boost in Heaven: <td width="60%"><center>(BP Multiplier for Kais in Heaven)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="kai_heaven_boost" value="[html_encode("[getFormVar("admin","kai_heaven_boost")]")]" size="3" maxlength="20"/><span class="error">[errors["kai_heaven_boost"]]</span></td></tr>

				<tr height="1em" valign="top"><td width="30%"><b>Dead BP Retention Ratio: <td width="60%"><center>(0.5 = 50% Power, 1=100% Power)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="dead_power_loss" value="[html_encode("[getFormVar("admin","dead_power_loss")]")]" size="3" maxlength="20"/><span class="error">[errors["dead_power_loss"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Keep Body BP Retention Ratio: <td width="60%"><center>(0.5 = 50% Power, 1=100% Power)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="keep_body_loss" value="[html_encode("[getFormVar("admin","keep_body_loss")]")]" size="3" maxlength="20"/><span class="error">[errors["keep_body_loss"]]</span></td></tr>

				<tr height="1em" valign="top"><td width="30%"><b>Reincarnation BP Retention Ratio: <td width="60%"><center>(0.01 = 1% Retention, 1=100% Retention)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="reincarnation_loss" value="[html_encode("[getFormVar("admin","reincarnation_loss")]")]" size="3" maxlength="20"/><span class="error">[errors["reincarnation_loss"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Reincarnation BP Recovery: <td width="60%"><center>(Multiplies rate at which you regain BP after Reincarnation)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="reincarnation_recovery" value="[html_encode("[getFormVar("admin","reincarnation_recovery")]")]" size="3" maxlength="20"/><span class="error">[errors["reincarnation_recovery"]]</span></td></tr>

				<tr height="1em" valign="top"><td width="30%"><b>Bind Limit: <td width="60%"><center>(0=No Limit, 1=Limit)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="limit_bind" value="[html_encode("[getFormVar("admin","limit_bind")]")]" size="3" maxlength="1"/><span class="error">[errors["limit_bind"]]</span></td></tr>

				<tr><td><br><center><b>Deadzone Pressure</b></center></td></tr>

				<tr height="1em" valign="top"><td width="30%"><br><b>Does Deadzone reduce the BP of races in it: <td width="60%"><center>(0 = False, 1 = True)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="deadzone_pressure_reduces_bp" value="[html_encode("[getFormVar("admin","deadzone_pressure_reduces_bp")]")]" size="3" maxlength="20"/><span class="error">[errors["deadzone_pressure_reduces_bp"]]</span></td></tr>

				<tr height="1em" valign="top"><td width="30%"><b>BP loss for resistance races in the Deadzone: <td width="60%"><center>(0.5 = 0.5x their normal BP, 1 = no bploss)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="DEADZONE_PRESSURE_BPLOSS_RESISTANT_RACE" value="[html_encode("[getFormVar("admin","DEADZONE_PRESSURE_BPLOSS_RESISTANT_RACE")]")]" size="3" maxlength="20"/><span class="error">[errors["DEADZONE_PRESSURE_BPLOSS_RESISTANT_RACE"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>BP loss for living players in the Deadzone: <td width="60%"><center>(0.5 = 0.5x their normal BP, 1 = no bploss)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="DEADZONE_PRESSURE_BPLOSS_LIVING" value="[html_encode("[getFormVar("admin","DEADZONE_PRESSURE_BPLOSS_LIVING")]")]" size="3" maxlength="20"/><span class="error">[errors["DEADZONE_PRESSURE_BPLOSS_LIVING"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>BP loss for players with keepbody in the Deadzone: <td width="60%"><center>(0.5 = 0.5x their normal BP, 1 = no bploss)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="DEADZONE_PRESSURE_BPLOSS_KEEPBODY" value="[html_encode("[getFormVar("admin","DEADZONE_PRESSURE_BPLOSS_KEEPBODY")]")]" size="3" maxlength="20"/><span class="error">[errors["DEADZONE_PRESSURE_BPLOSS_KEEPBODY"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>BP loss for dead players in the Deadzone: <td width="60%"><center>(0.5 = 0.5x their normal BP, 1 = no bploss)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="DEADZONE_PRESSURE_BPLOSS_DEAD" value="[html_encode("[getFormVar("admin","DEADZONE_PRESSURE_BPLOSS_DEAD")]")]" size="3" maxlength="20"/><span class="error">[errors["DEADZONE_PRESSURE_BPLOSS_DEAD"]]</span></td></tr>

				<tr height="1em" valign="top"><td width="30%"><b>Races that are Immune against Deadzone bploss: <td width="60%"><center>(default = Android, Demon)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="DEADZONE_PRESSURE_BPLOSS_IMMUNE_RACES" value="[html_encode("[getFormVar("admin","DEADZONE_PRESSURE_BPLOSS_IMMUNE_RACES")]")]" size="3" maxlength="20"></input><a href="byond://?src=\ref[src]&action=deadzone_pressure_immune">\[Edit\]</a><span class="error">[errors["DEADZONE_PRESSURE_BPLOSS_IMMUNE_RACES"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Races that are resistant against Deadzone bploss: <td width="60%"><center>(default = Kai, Demigod, Cyberbp)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="DEADZONE_PRESSURE_BPLOSS_RESISTANT_RACES" value="[html_encode("[getFormVar("admin","DEADZONE_PRESSURE_BPLOSS_RESISTANT_RACES")]")]" size="3" maxlength="20"></input><a href="byond://?src=\ref[src]&action=deadzone_pressure_resistant">\[Edit\]</a><span class="error">[errors["DEADZONE_PRESSURE_BPLOSS_RESISTANT_RACES"]]</span></td></tr>


				<tr><td><br><center><b>Limit Break</b></center></td></tr>

				<tr height="1em" valign="top"><td width="30%"><br><b>Can players gain Mastery in Limit Break: <td width="60%"><center>(0 = False, 1 = True)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="limitbreak_mastery" value="[html_encode("[getFormVar("admin","limitbreak_mastery")]")]" size="3" maxlength="20"/><span class="error">[errors["limitbreak_mastery"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Maximum mastery for Limit Break: <td width="60%"><center>(10 = 1 second, 600 = 60 seconds ))</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="limitbreak_maximum_mastery" value="[html_encode("[getFormVar("admin","limitbreak_maximum_mastery")]")]" size="3" maxlength="20"/><span class="error">[errors["limitbreak_maximum_mastery"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Limit breaker minimum duration modifier: <td width="60%"><center>(1 = no change, 0.5 = half mastery (60 -> 30 seconds), default = 1)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="limitbreak_minimum_duration" value="[html_encode("[getFormVar("admin","limitbreak_minimum_duration")]")]" size="3" maxlength="20"/><span class="error">[errors["limitbreak_minimum_duration"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Limit breaker maximum duration modifier: <td width="60%"><center>(2 = 2x maximum mastery (60 -> 120 seconds), default = 2)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="limitbreak_maximum_duration" value="[html_encode("[getFormVar("admin","limitbreak_maximum_duration")]")]" size="3" maxlength="20"/><span class="error">[errors["limitbreak_maximum_duration"]]</span></td></tr>

				<tr><td><br><center><b>Hakai</b></center></td></tr>

				<tr height="1em" valign="top"><td width="30%"><br><b>Hakai Cooldown: <td width="60%"><center>(300 = 30 Seconds, 10 = 1 Second)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="hakai_cooldown" value="[html_encode("[getFormVar("admin","hakai_cooldown")]")]" size="3" maxlength="20"/><span class="error">[errors["hakai_cooldown"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Hakai BP Requirement: <td width="60%"><center>(2.2 = 2.2x Target's BP Required)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="hakai_bp_advantage_needed" value="[html_encode("[getFormVar("admin","hakai_bp_advantage_needed")]")]" size="3" maxlength="20"/><span class="error">[errors["hakai_bp_advantage_needed"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Hakai Wipes Save: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="hakai_wipes_character" value="[html_encode("[getFormVar("admin","hakai_wipes_character")]")]" size="3" maxlength="1"/><span class="error">[errors["hakai_wipes_character"]]</span></td></tr>

				<tr><td><br><center><b>Movement</b></center></td></tr>

				<tr height="1em" valign="top"><td width="30%"><br><b>Stun Stops Movement: <td width="60%"><center>(0=No, 1=Yes)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="stun_stops_movement" value="[html_encode("[getFormVar("admin","stun_stops_movement")]")]" size="3" maxlength="1"/><span class="error">[errors["stun_stops_movement"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Force 32px Movement: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="force_32_pix_movement" value="[html_encode("[getFormVar("admin","force_32_pix_movement")]")]" size="3" maxlength="1"/><span class="error">[errors["force_32_pix_movement"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Diagonal Movement: <td width="60%"><center>(0=Off, 1=On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="allow_diagonal_movement" value="[html_encode("[getFormVar("admin","allow_diagonal_movement")]")]" size="3" maxlength="1"/><span class="error">[errors["allow_diagonal_movement"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Base Movement Delay: <td width="60%"><center>(Changes Base Move Delay)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="BASE_MOVE_DELAY" value="[html_encode("[getFormVar("admin","BASE_MOVE_DELAY")]")]" size="3" maxlength="20"/><span class="error">[errors["BASE_MOVE_DELAY"]]</span></td></tr>

				<tr><td><br><center><b>Planet Destroy</b></center></td></tr>

				<tr height="1em" valign="top"><td width="30%"><br><b>Planet Destroy Immunity Timer: <td width="60%"><center>(Changes Planet Destroy Immunity Time)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="planet_destroy_immunity_time" value="[html_encode("[getFormVar("admin","planet_destroy_immunity_time")]")]" size="3" maxlength="20"/><span class="error">[errors["planet_destroy_immunity_time"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Planet Destroy BP Requirement: <td width="60%"><center>(Changes Planet Destroy Bp Requirement)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="planet_destroy_bp_requirement" value="[html_encode("[getFormVar("admin","planet_destroy_bp_requirement")]")]" size="3" maxlength="20"/><span class="error">[errors["planet_destroy_bp_requirement"]]</span></td></tr>

				<tr><td><br><center><b>Sparring</b></center></td></tr>

				<tr height="1em" valign="top"><td width="30%"><br><b>Comes back from spar in Full Health: <td width="60%"><center>(0 = False, 1 = True)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="KO_SYSTEM_FULL_HEAL_IN_SPAR" value="[html_encode("[getFormVar("admin","KO_SYSTEM_FULL_HEAL_IN_SPAR")]")]" size="3" maxlength="1"/><span class="error">[errors["KO_SYSTEM_FULL_HEAL_IN_SPAR"]]</span></td></tr>
		...
		GenerateBody(list/errors=list())
			...
			<form name="info" action="byond://" method="get">
			  ...
			  <tr height="12px"><td colspan="4">
				...
				<tr height="1em" valign="top"><td width="30%"><b>drone_genocide_off: <td width="60%"><center>(Toggles Drone Genocide Off)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="drone_genocide_off" value="[html_encode("[getFormVar("admin","drone_genocide_off")]")]" size="3" maxlength="1"/><span class="error">[errors["drone_genocide_off"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>death_cures_vampires: <td width="60%"><center>(Toggles Death Cures Vampires)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="death_cures_vampires" value="[html_encode("[getFormVar("admin","death_cures_vampires")]")]" size="3" maxlength="1"/><span class="error">[errors["death_cures_vampires"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>customBuildAllowed: <td width="60%"><center>(Toggles Custombuildallowed)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="customBuildAllowed" value="[html_encode("[getFormVar("admin","customBuildAllowed")]")]" size="3" maxlength="1"/><span class="error">[errors["customBuildAllowed"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>toxic_waste_on: <td width="60%"><center>(Toggles Toxic Waste On)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="toxic_waste_on" value="[html_encode("[getFormVar("admin","toxic_waste_on")]")]" size="3" maxlength="1"/><span class="error">[errors["toxic_waste_on"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Max_Zombies: <td width="60%"><center>(Changes Max Zombies)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Max_Zombies" value="[html_encode("[getFormVar("admin","Max_Zombies")]")]" size="3" maxlength="20"/><span class="error">[errors["Max_Zombies"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>max_gravity: <td width="60%"><center>(Changes Max Gravity)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="max_gravity" value="[html_encode("[getFormVar("admin","max_gravity")]")]" size="3" maxlength="20"/><span class="error">[errors["max_gravity"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>cyber_bp_mod: <td width="60%"><center>(Changes Cyber Bp Mod)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="cyber_bp_mod" value="[html_encode("[getFormVar("admin","cyber_bp_mod")]")]" size="3" maxlength="20"/><span class="error">[errors["cyber_bp_mod"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>percent_of_wall_breakers: <td width="60%"><center>(Changes Percent Of Wall Breakers)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="percent_of_wall_breakers" value="[html_encode("[getFormVar("admin","percent_of_wall_breakers")]")]" size="3" maxlength="20"/><span class="error">[errors["percent_of_wall_breakers"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>wall_INT_scaling: <td width="60%"><center>(Changes Wall Int Scaling)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="wall_INT_scaling" value="[html_encode("[getFormVar("admin","wall_INT_scaling")]")]" size="3" maxlength="20"/><span class="error">[errors["wall_INT_scaling"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>minimum_bounty: <td width="60%"><center>(Changes Minimum Bounty)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="minimum_bounty" value="[html_encode("[getFormVar("admin","minimum_bounty")]")]" size="3" maxlength="20"/><span class="error">[errors["minimum_bounty"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>knowledge_cap_mod: <td width="60%"><center>(Changes Knowledge Cap Mod)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="knowledge_cap_mod" value="[html_encode("[getFormVar("admin","knowledge_cap_mod")]")]" size="3" maxlength="20"/><span class="error">[errors["knowledge_cap_mod"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>zombie_power_mult: <td width="60%"><center>(Changes Zombie Power Mult)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="zombie_power_mult" value="[html_encode("[getFormVar("admin","zombie_power_mult")]")]" size="3" maxlength="20"/><span class="error">[errors["zombie_power_mult"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>drone_power: <td width="60%"><center>(Changes Drone Power)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="drone_power" value="[html_encode("[getFormVar("admin","drone_power")]")]" size="3" maxlength="20"/><span class="error">[errors["drone_power"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>building_price_mult: <td width="60%"><center>(Changes Building Price Mult)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="building_price_mult" value="[html_encode("[getFormVar("admin","building_price_mult")]")]" size="3" maxlength="20"/><span class="error">[errors["building_price_mult"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>checkpointBuildDist: <td width="60%"><center>(Changes Checkpointbuilddist)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="checkpointBuildDist" value="[html_encode("[getFormVar("admin","checkpointBuildDist")]")]" size="3" maxlength="20"/><span class="error">[errors["checkpointBuildDist"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>drone_limit: <td width="60%"><center>(Changes Drone Limit)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="drone_limit" value="[html_encode("[getFormVar("admin","drone_limit")]")]" size="3" maxlength="20"/><span class="error">[errors["drone_limit"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>body_swap_time_limit: <td width="60%"><center>(Changes Body Swap Time Limit)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="body_swap_time_limit" value="[html_encode("[getFormVar("admin","body_swap_time_limit")]")]" size="3" maxlength="20"/><span class="error">[errors["body_swap_time_limit"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Turf_Strength: <td width="60%"><center>(Changes Turf Strength)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Turf_Strength" value="[html_encode("[getFormVar("admin","Turf_Strength")]")]" size="3" maxlength="20"/><span class="error">[errors["Turf_Strength"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>max_turf_str: <td width="60%"><center>(Changes Max Turf Str)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="max_turf_str" value="[html_encode("[getFormVar("admin","max_turf_str")]")]" size="3" maxlength="20"/><span class="error">[errors["max_turf_str"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>zombie_reproduce_mod: <td width="60%"><center>(Changes Zombie Reproduce Mod)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="zombie_reproduce_mod" value="[html_encode("[getFormVar("admin","zombie_reproduce_mod")]")]" size="3" maxlength="20"/><span class="error">[errors["zombie_reproduce_mod"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Prison_Money: <td width="60%"><center>(Changes Prison Money)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Prison_Money" value="[html_encode("[getFormVar("admin","Prison_Money")]")]" size="3" maxlength="20"/><span class="error">[errors["Prison_Money"]]</span></td></tr>
				<tr height="1em" valign="top"><td width="30%"><b>Gun_Power: <td width="60%"><center>(Changes Gun Power)</center></td></b></td><td width="10%" colspan="3"><input class="form" type="text" name="Gun_Power" value="[html_encode("[getFormVar("admin","Gun_Power")]")]" size="3" maxlength="20"/><span class="error">[errors["Gun_Power"]]</span></td></tr>
