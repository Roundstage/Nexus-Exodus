...
proc/initializeNexusAdminActions()
	...
	nexus_admin_action_catalog["test_combat_effects"] = new /datum/NexusAdminAction("test_combat_effects", "Test Weapon and Rock Effects", "Testing", "Preview the CC0 sword and stone sound banks with their layered visual effects without dealing damage.", 3, FALSE, TRUE)
