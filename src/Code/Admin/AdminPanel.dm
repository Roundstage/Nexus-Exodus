...
proc/initializeNexusAdminActions()
	...
	nexus_admin_action_catalog["give_rare_race"] = new /datum/NexusAdminAction("give_rare_race", "Give Rare Race", "Character", "Grant the selected account Legendary Saiyan, Frost Lord, Cooler, Grand Regent, or every rare option for testing.", 3, TRUE, TRUE)
