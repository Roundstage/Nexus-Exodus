...
proc/initializeArcaneFormulaCatalog()
	...
	registerArcaneFormula(new /datum/ArcaneFormula("magic_sword", "Magic Sword", "A Normal Sword with the same combat stats and forge upgrades as Science equipment.", /obj/items/Sword/Forged/ArcaneSword, 80, /obj/items/Ore/Copper, 3))
	registerArcaneFormula(new /datum/ArcaneFormula("magic_gauntlets", "Magic Gauntlets", "Normal Gloves with the same unarmed combat stats and forge upgrades as Science equipment.", /obj/items/ArcaneFocusGauntlets, 100, /obj/items/Ore/Silver, 1))
	...
	registerArcaneFormula(new /datum/ArcaneFormula("magic_hammer", "Magic Hammer", "A Normal War Hammer with the same combat stats and forge upgrades as Science equipment.", /obj/items/Sword/Forged/MagicHammer, 90, /obj/items/Ore/Copper, 3))
