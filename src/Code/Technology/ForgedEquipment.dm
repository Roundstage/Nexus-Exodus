...
proc/initializeForgedEquipmentCatalogs()
	...
	if(!islist(forged_weapon_style_catalog) || !forged_weapon_style_catalog.len)
		...
		forged_weapon_style_catalog["trunks"] = new /datum/ForgedWeaponStyle("trunks", "Trunks", "Sword", 'src/Icons/Objects/Swords/RTSwordTrunks.dmi', "A compact Nexus sword skin.")
		forged_weapon_style_catalog["knight"] = new /datum/ForgedWeaponStyle("knight", "Knight", "Sword", 'src/Icons/Objects/Swords/RTIronSword.dmi', "A broad knight sword skin.")
		forged_weapon_style_catalog["demon"] = new /datum/ForgedWeaponStyle("demon", "Demon", "Sword", 'src/Icons/Objects/Swords/RTCopperSword.dmi', "A curved demonic sword skin.")
		forged_weapon_style_catalog["katana"] = new /datum/ForgedWeaponStyle("katana", "Katana", "Katana", 'src/Icons/Objects/Swords/RTKatana2.dmi', "A single-edged katana skin.")
		forged_weapon_style_catalog["long_katana"] = new /datum/ForgedWeaponStyle("long_katana", "Long Katana", "Katana", 'src/Icons/Objects/Swords/RTKatana.dmi', "An extended katana skin.")
		forged_weapon_style_catalog["short_sword"] = new /datum/ForgedWeaponStyle("short_sword", "Short Sword", "Short Sword", 'src/Icons/Objects/Swords/RTShortSword.dmi', "A compact short-blade skin.")
		forged_weapon_style_catalog["rebellion"] = new /datum/ForgedWeaponStyle("rebellion", "Rebellion", "Sword", 'src/Icons/Objects/Items/ItemSword1.dmi', "The Rebellion appearance; visual only.")
		forged_weapon_style_catalog["buster"] = new /datum/ForgedWeaponStyle("buster", "Buster", "Great Sword", 'src/Icons/Objects/Items/ItemBusterSword.dmi', "The Buster appearance; visual only.")
		forged_weapon_style_catalog["great_sword"] = new /datum/ForgedWeaponStyle("great_sword", "Great Sword", "Great Sword", 'src/Icons/Objects/Items/ItemGreatSword.dmi', "A massive great-sword skin.")
		forged_weapon_style_catalog["flame"] = new /datum/ForgedWeaponStyle("flame", "Flame", "Sword", 'src/Icons/Objects/Swords/RTMythrilSword.dmi', "A flame-shaped sword skin; material determines damage type.")
		forged_weapon_style_catalog["samurai"] = new /datum/ForgedWeaponStyle("samurai", "Samurai", "Katana", 'src/Icons/Objects/Swords/RTAuraciteSword.dmi', "An ornate samurai blade skin.")
		forged_weapon_style_catalog["hammer"] = new /datum/ForgedWeaponStyle("hammer", "War Hammer", "War Hammer", 'src/Icons/Objects/Swords/RTHammer.dmi', "A forged war-hammer skin.")
		forged_weapon_style_catalog["sledgehammer"] = new /datum/ForgedWeaponStyle("sledgehammer", "Sledgehammer", "Sledgehammer", 'src/Icons/Objects/Swords/RTSledgehammer.dmi', "A two-handed sledgehammer skin.")
		forged_weapon_style_catalog["mage_staff"] = new /datum/ForgedWeaponStyle("mage_staff", "Mage Staff", "Staff", 'src/Icons/Objects/Swords/RTMageStaff.dmi', "A mage-staff skin; Auracite supplies energy conduction.")
		forged_weapon_style_catalog["du_sword_2"] = new /datum/ForgedWeaponStyle("du_sword_2", "DU Sword II", "Sword", 'src/Icons/Objects/Swords/Sword2.dmi', "A legacy DU sword appearance.")
		forged_weapon_style_catalog["du_sword_1"] = new /datum/ForgedWeaponStyle("du_sword_1", "DU Sword I", "Sword", 'src/Icons/Objects/Swords/Sword1.dmi', "A legacy DU sword appearance.")
		forged_weapon_style_catalog["du_katana_2"] = new /datum/ForgedWeaponStyle("du_katana_2", "DU Katana II", "Katana", 'src/Icons/Objects/Items/ItemKatana2.dmi', "A legacy DU katana appearance.")
		forged_weapon_style_catalog["du_katana"] = new /datum/ForgedWeaponStyle("du_katana", "DU Katana", "Katana", 'src/Icons/Objects/Items/ItemKatana.dmi', "A legacy DU katana appearance.")
		forged_weapon_style_catalog["du_short_sword"] = new /datum/ForgedWeaponStyle("du_short_sword", "DU Short Sword", "Short Sword", 'src/Icons/Objects/Swords/ShortSword.dmi', "A legacy DU short-sword appearance.")
		forged_weapon_style_catalog["dual_blaze"] = new /datum/ForgedWeaponStyle("dual_blaze", "Dual Blaze", "Dual Blades", 'src/Icons/Objects/Items/ItemDualBlazeSword.dmi', "A legacy DU dual-blade appearance.")
		forged_weapon_style_catalog["dual_electric"] = new /datum/ForgedWeaponStyle("dual_electric", "Dual Electric", "Dual Blades", 'src/Icons/Objects/Items/ItemDualElectricSword.dmi', "A legacy DU dual-blade appearance.")
		forged_weapon_style_catalog["legacy_flame"] = new /datum/ForgedWeaponStyle("legacy_flame", "Legacy Flame", "Sword", 'src/Icons/Objects/Swords/SwordFlameComplete.dmi', "A legacy DU flame-sword appearance.")
		forged_weapon_style_catalog["twin_katanas"] = new /datum/ForgedWeaponStyle("twin_katanas", "Twin Katanas", "Dual Katanas", 'src/Icons/Objects/Swords/Sword2Katanas.dmi', "A legacy DU paired-katana appearance.")
		forged_weapon_style_catalog["legacy_samurai"] = new /datum/ForgedWeaponStyle("legacy_samurai", "Legacy Samurai", "Katana", 'src/Icons/Objects/Swords/SwordSamurai.dmi', "A legacy DU samurai appearance.")
		forged_weapon_style_catalog["legacy_trunks"] = new /datum/ForgedWeaponStyle("legacy_trunks", "Legacy Trunks", "Sword", 'src/Icons/Objects/Swords/SwordTrunks.dmi', "The original DU Trunks sword appearance.")
		forged_weapon_style_catalog["false_neoblade"] = new /datum/ForgedWeaponStyle("false_neoblade", "False Neoblade", "Sword", 'src/Icons/Objects/Swords/Falseneoblade.dmi', "A legacy DU sword appearance.")
		forged_weapon_style_catalog["kingdom_key"] = new /datum/ForgedWeaponStyle("kingdom_key", "Kingdom Key", "Keyblade", 'src/Icons/Objects/Swords/KingdomKey.dmi', "A legacy DU key-shaped appearance.")
		forged_weapon_style_catalog["ki_sword"] = new /datum/ForgedWeaponStyle("ki_sword", "Ki Sword", "Sword", 'src/Icons/Objects/Swords/KiSword.dmi', "A legacy DU energy-blade appearance; material still determines damage type.")
		forged_weapon_style_catalog["yin_yang"] = new /datum/ForgedWeaponStyle("yin_yang", "Yin Yang", "Sword", 'src/Icons/Objects/Swords/YinYang.dmi', "A legacy DU sword appearance.")
	if(!islist(forged_armor_style_catalog) || !forged_armor_style_catalog.len)
		forged_armor_style_catalog = list()
		forged_armor_style_catalog["classic"] = new /datum/ForgedArmorStyle("classic", "Classic Armor", 'src/Icons/PlayerIcons/Clothes/Armor/RTCopperArmor.dmi')
		forged_armor_style_catalog["battle_2"] = new /datum/ForgedArmorStyle("battle_2", "Nexus Armor II", 'src/Icons/PlayerIcons/Clothes/Armor/Armor2.dmi')
		forged_armor_style_catalog["battle_3"] = new /datum/ForgedArmorStyle("battle_3", "Nexus Armor III", 'src/Icons/PlayerIcons/Clothes/Armor/Armor3.dmi')
		forged_armor_style_catalog["battle_4"] = new /datum/ForgedArmorStyle("battle_4", "Nexus Armor IV", 'src/Icons/PlayerIcons/Clothes/Armor/Armor4.dmi')
		forged_armor_style_catalog["battle_5"] = new /datum/ForgedArmorStyle("battle_5", "Nexus Armor V", 'src/Icons/PlayerIcons/Clothes/Armor/Armor5.dmi')
		forged_armor_style_catalog["battle_6"] = new /datum/ForgedArmorStyle("battle_6", "Nexus Armor VI", 'src/Icons/PlayerIcons/Clothes/Armor/Armor6.dmi')
		forged_armor_style_catalog["battle_7"] = new /datum/ForgedArmorStyle("battle_7", "Nexus Armor VII", 'src/Icons/PlayerIcons/Clothes/Armor/Armor7.dmi')
		forged_armor_style_catalog["bardock"] = new /datum/ForgedArmorStyle("bardock", "Bardock Armor", 'src/Icons/PlayerIcons/Clothes/Armor/RTBardockArmor.dmi')
		forged_armor_style_catalog["turles"] = new /datum/ForgedArmorStyle("turles", "Turles Armor", 'src/Icons/PlayerIcons/Clothes/TurlesArmor.dmi')
		forged_armor_style_catalog["nappa"] = new /datum/ForgedArmorStyle("nappa", "Nappa Armor", 'src/Icons/PlayerIcons/Clothes/Armor/NappaArmor.dmi')
		forged_armor_style_catalog["azure"] = new /datum/ForgedArmorStyle("azure", "Azure Armor", 'src/Icons/PlayerIcons/Clothes/Armor/RTIronArmor.dmi')
		forged_armor_style_catalog["mythril"] = new /datum/ForgedArmorStyle("mythril", "Mythril Armor", 'src/Icons/PlayerIcons/Clothes/Armor/RTMythrilArmor.dmi')
		forged_armor_style_catalog["auracite"] = new /datum/ForgedArmorStyle("auracite", "Auracite Armor", 'src/Icons/PlayerIcons/Clothes/Armor/RTAuraciteArmor.dmi')
		forged_armor_style_catalog["du_armor_1"] = new /datum/ForgedArmorStyle("du_armor_1", "DU Armor I", 'src/Icons/PlayerIcons/Clothes/Armor/Armor1.dmi')
		forged_armor_style_catalog["white_male"] = new /datum/ForgedArmorStyle("white_male", "White Armor", 'src/Icons/PlayerIcons/Clothes/Armor/WhiteMaleArmor.dmi')
		forged_armor_style_catalog["legacy_bardock"] = new /datum/ForgedArmorStyle("legacy_bardock", "Legacy Bardock Armor", 'src/Icons/PlayerIcons/Clothes/Armor/ArmorBardock.dmi')
		forged_armor_style_catalog["dynasty_red"] = new /datum/ForgedArmorStyle("dynasty_red", "Red Dynasty Armor", 'src/Icons/PlayerIcons/Clothes/Armor/GinsDynastyArmorRed.dmi')
		forged_armor_style_catalog["phoenix_makyo"] = new /datum/ForgedArmorStyle("phoenix_makyo", "Makyo Phoenix Armor", 'src/Icons/PlayerIcons/Clothes/Exgenesis1212012/PhoenixArmour/PhoenixFullMakyo.dmi')
		forged_armor_style_catalog["phoenix_moonlight"] = new /datum/ForgedArmorStyle("phoenix_moonlight", "Moonlight Phoenix Armor", 'src/Icons/PlayerIcons/Clothes/Exgenesis1212012/PhoenixArmour/PhoenixFullMoonlight.dmi')
		forged_armor_style_catalog["phoenix_negative_makyo"] = new /datum/ForgedArmorStyle("phoenix_negative_makyo", "Negative Makyo Phoenix Armor", 'src/Icons/PlayerIcons/Clothes/Exgenesis1212012/PhoenixArmour/PhoenixFullNegativeMakyo.dmi')
		forged_armor_style_catalog["phoenix_negative"] = new /datum/ForgedArmorStyle("phoenix_negative", "Negative Phoenix Armor", 'src/Icons/PlayerIcons/Clothes/Exgenesis1212012/PhoenixArmour/PhoenixFullNegative.dmi')
		forged_armor_style_catalog["phoenix"] = new /datum/ForgedArmorStyle("phoenix", "Phoenix Armor", 'src/Icons/PlayerIcons/Clothes/Exgenesis1212012/PhoenixArmour/PhoenixFull.dmi')
		forged_armor_style_catalog["wtf"] = new /datum/ForgedArmorStyle("wtf", "WTF Armor", 'src/Icons/PlayerIcons/TobiUchihaIcons/WtfArmor.dmi')
		forged_armor_style_catalog["blue"] = new /datum/ForgedArmorStyle("blue", "Blue Armor", 'src/Icons/PlayerIcons/TobiUchihaIcons/BlueArmor.dmi')
		forged_armor_style_catalog["red"] = new /datum/ForgedArmorStyle("red", "Red Armor", 'src/Icons/PlayerIcons/TobiUchihaIcons/RedArmor.dmi')
		forged_armor_style_catalog["raditz_tobi"] = new /datum/ForgedArmorStyle("raditz_tobi", "Raditz Tobi Armor", 'src/Icons/PlayerIcons/TobiUchihaIcons/RaditzArmorTobiUchiha.dmi')
		forged_armor_style_catalog["turles_tobi"] = new /datum/ForgedArmorStyle("turles_tobi", "Turles Tobi Armor", 'src/Icons/PlayerIcons/TobiUchihaIcons/TurlesArmorTobiUchiha.dmi')
	if(!islist(forged_glove_style_catalog) || !forged_glove_style_catalog.len)
		forged_glove_style_catalog = list()
		forged_glove_style_catalog["classic"] = new /datum/ForgedGloveStyle("classic", "Classic", "Gloves", 'src/Icons/PlayerIcons/Clothes/ClothesGloves.dmi')
		forged_glove_style_catalog["saiyan"] = new /datum/ForgedGloveStyle("saiyan", "Saiyan", "Gloves", 'src/Icons/PlayerIcons/Clothes/ClothesSaiyanGloves.dmi')
		forged_glove_style_catalog["hero"] = new /datum/ForgedGloveStyle("hero", "Hero", "Gloves", 'src/Icons/PlayerIcons/Saitama/OpmGloves.dmi')
		forged_glove_style_catalog["boxing"] = new /datum/ForgedGloveStyle("boxing", "Arcane Boxing", "Boxing Gloves", 'src/Icons/NexusIntegrated/Magic/RTEnchantmentItems.dmi', "RoS")
	if(!islist(forged_mask_style_catalog) || !forged_mask_style_catalog.len)
		forged_mask_style_catalog = list()
		forged_mask_style_catalog["normal"] = new /datum/ForgedMaskStyle("normal", "Normal Mask", 'src/Icons/PlayerIcons/Clothes/Mask.dmi')
		forged_mask_style_catalog["ninja"] = new /datum/ForgedMaskStyle("ninja", "Ninja Mask", 'src/Icons/PlayerIcons/Clothes/ClothesNinjaMask.dmi')
		forged_mask_style_catalog["ninja_2"] = new /datum/ForgedMaskStyle("ninja_2", "Ninja Mask II", 'src/Icons/PlayerIcons/Clothes/ClothesNinjaMask2.dmi')
...
obj/Forge
	...
	icon = 'src/Icons/Objects/Technology/RTForge.dmi'
	density = 1
	Health = 100000
	Cost = 250000
	Savable = 1
...
obj/items/Digging/NexusPickaxe
	...
	icon = 'src/Icons/Objects/Technology/RTPickaxe.dmi'
	DigMult = 5
	Cost = 0
	Stealable = 1
