		...
		switch(input(src,"Choose what you want to do. If you know the first letter of the option you seek you can press it to cycle through them faster") in Choices)
			...
			if("Use Custom Icer Form Icons")
				switch(input(src, "Which form?", "Options") in list("Cancel","Base Form","2nd Form","3rd Form","Final Form", "Cooler","Golden Form"))
					...
					if("Cooler") ChangeIcerFormIcon(form = 5)
					if("Golden Form") ChangeIcerFormIcon(form = 6)

			if("Manage Visual Layers") manageVisualLayers()
			if("View Visual Layers") viewVisualLayers()
