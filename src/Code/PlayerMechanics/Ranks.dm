...
mob/proc/Braal(mob/P)
	...
	contents.Add(new/obj/Attacks/Explosion,new/obj/Attacks/Final_Flash,new/obj/Attacks/Garlic_Gun,\
...
mob/proc/Cell(mob/P)
	...
	new/obj/Attacks/Explosion,new/obj/Attacks/Garlic_Gun,new/obj/Attacks/Scatter_Shot,\
