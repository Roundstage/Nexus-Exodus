...
obj/Connector
	icon = 'src/Icons/Technology/ConnectorIcons.dmi'
	icon_state = "h"
	...
	New()
		GiveLightSource(size = 20, max_alpha = 35, light_color = default_electricity_color, auto_fade = 0, light_icon = 'src/Icons/Unsorted/Transparent.png')
