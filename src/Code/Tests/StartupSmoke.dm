...
proc/runStartupSmokeTests(soul_contract_count_before)
	...
	nexusSmokeAssert(islist(nexus_chat_output_controls["all"]) && nexus_chat_output_controls["all"].len == 3 && nexus_chat_output_controls["combat"].len == 3, "chat output routing does not cover every HUD layout")
