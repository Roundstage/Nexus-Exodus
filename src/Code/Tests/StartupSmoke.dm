...
proc/runStartupSmokeTests(soul_contract_count_before)
	...
	nexusSmokeAssert(lethal_button.screen_loc == "RIGHT:-8,TOP:-8" && rp_mode_button.screen_loc == "RIGHT:-8,TOP:-40" && character_button.screen_loc == "RIGHT:-8,TOP:-72", "action HUD buttons are not pixel-anchored in the upper-right corner")
	...
	nexusSmokeAssert(smithing_recipe_catalog.len == 8 && smithing_recipe_catalog["auracite_armor"], "smithing recipe catalog is incomplete")
	...
	var/obj/items/Sword/Forged/Copper/smoke_sword = new(profession_test)
