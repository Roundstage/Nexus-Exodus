...
proc/runStartupSmokeTests(soul_contract_count_before)
	...
	nexusSmokeAssert(nexus_hotkey_action_registry.len == 17, "directional movement or Cycle Target hotkey action registry is incomplete")
	...
	nexusSmokeAssert(findtext(empty_hotkey_html, "Short Dash: North") && findtext(empty_hotkey_html, "Short Dash: Northwest") && findtext(empty_hotkey_html, "Cycle Target"), "hotkey editor does not expose all universal movement and targeting actions")
